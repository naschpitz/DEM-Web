...
export default class VideosDAO {
  static addFile(...args) {
    return VideosCol.addFile(...args);
  }

  static find(...args) {
    return VideosCol.find(...args);
  }

  static findOne(...args) {
    return VideosCol.findOne(...args);
  }

  static insert(...args) {
    return VideosCol.insert(...args);
  }

  static update(...args) {
    return VideosCol.update(...args);
  }

  static upsert(...args) {
    return VideosCol.upsert(...args);
  }

  static remove(...args) {
    return VideosCol.remove(...args);
  }
