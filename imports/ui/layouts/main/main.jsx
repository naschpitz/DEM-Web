...
const Servers = Loadable({
    loader: () => { return import('../../components/servers/servers.jsx'); },
    render(loaded, props) {
        let Component = loaded.default;
        return <Component {...props}/>;
    },
...
const Simulation = Loadable({
    loader: () => { return import('../../components/simulations/simulation/simulation.jsx'); },
    render(loaded, props) {
        let Component = loaded.default;
        return <Component {...props}/>;
    },
...
const Simulations = Loadable({
    loader: () => { return import('../../components/simulations/simulations.jsx'); },
    render(loaded, props) {
        let Component = loaded.default;
        return <Component {...props}/>;
    },
