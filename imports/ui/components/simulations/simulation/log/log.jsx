...
export default Log = (props) => {
    ...
    const simulationLogs = useTracker(() => {
        return SimulationsLogsClass.find({owner: props.simulationId, progress: {$exists: true}}, {sort: {'createdAt': -1}}).fetch();
    });
                    ...
                    <div className="col-sm-4 col-md-3 col-lg-2">
                        <div className="progress text-center">
                            <div className={progressBarClassName} role="progressbar"
                                 aria-valuenow={percentage.value} aria-valuemin="0"
                                 aria-valuemax="100" style={{width: percentage.value + '%', color: 'black'}}>
                                {percentage.text}
                            </div>
