...
export default Charts = (props) => {
    ...
    return (
        <div id="charts">
            ...
            {objectId && dataName ?
                <div>
                    <Chart sceneryId={sceneryId} objectId={objectId} dataName={dataName} minInterval={minInterval} maxInterval={maxInterval}/>
                    <DataExporter sceneryId={sceneryId} objectId={objectId} dataName={dataName} minInterval={minInterval} maxInterval={maxInterval}/>
                </div>
                : null
            }
        </div>
