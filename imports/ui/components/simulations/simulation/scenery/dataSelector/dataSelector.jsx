...
export default DataSelector = (props) => {
    ...
    function onEvent(event, name, value) {
        if (!(event === 'onBlur' || (event === 'onChange' && (name === 'dataName' || name === 'objectId'))))
            return;
    ...
    function renderTimeInput(title, name) {
        ...
        switch (name) {
            case 'minInterval': value = data.minInterval; break;
            case 'maxInterval': value = data.maxInterval; break;
        }
        ...
        <div id="selector">
            <div className="row">
                ...
                <div className="col-sm-6 col-md-6 col-lg-2">
                    {renderTimeInput("Min Time", "minInterval")}
                </div>

                <div className="col-sm-6 col-md-6 col-lg-2">
                    {renderTimeInput("Max Time", "maxInterval")}
                </div>
            </div>
        </div>
    );
