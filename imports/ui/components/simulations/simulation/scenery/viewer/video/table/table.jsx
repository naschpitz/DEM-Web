...
export default Table = ({sceneryId}) => {
    ...
    function getColumns() {
        ...
        return [{
            ...
            id: 'downloadButton',
            className: 'text-center',
            Cell: (cellInfo) => (<ButtonEnhanced buttonOptions={{id: "btnDownload",
                                                                 disabled: isDisabled(cellInfo),
                                                                 regularText: <a href={getUrl(cellInfo.original._id)}
                                                                                 download={cellInfo.original.name}
            ...
            Cell: (cellInfo) => (<ButtonEnhanced buttonOptions={{regularText: "Remove",
                                                                 ...
                                                                 actionText: "Removing...",
                                                                 type: "button"}}
                                                 confirmationOptions={{title: "Confirm video removal",
                                                                       text: <span>Do you really want to remove the video <strong>{cellInfo.original.name}</strong> ?</span>,
