        ...
        <div id="frameControl">
            <div className="row">
                <div className="col-sm-3 col-md-3 text-center">
                    <ButtonEnhanced buttonOptions={{regularText: <FaFastBackward className="align-middle"/>,
                ...
                <div className="col-sm-3 col-md-3 text-center">
                    <ButtonEnhanced buttonOptions={{regularText: <FaStepBackward className="align-middle"/>,
                                                    className: "btn btn-primary",
                                                    type: "button",
                ...
                <div className="col-sm-3 col-md-3 text-center">
                    <ButtonEnhanced buttonOptions={{regularText: <FaStepForward className="align-middle"/>,
                                                    className: "btn btn-primary",
                                                    type: "button",
                ...
                <div className="col-sm-3 col-md-3 text-center">
                    <ButtonEnhanced buttonOptions={{regularText: <FaFastForward className="align-middle"/>,
                                                    className: "btn btn-primary",
                                                    type: "button",
