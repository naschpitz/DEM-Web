...
export default () => {
  return (
    <div id="terms" className="container text-justify">
      ...
      <p>
        Welcome to <b>DEM.naschpitz.com</b> (“Company”, “we”, “our”, “us”)!
      </p>
      <p>
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of our website located at{" "}
        <b>dem.naschpitz.com</b> (together or individually “Service”) operated by <b>Naschpitz.com</b>.
      </p>
      <p>
      ...
      <p>
        ...
        know by emailing at <b>contact@naschpitz.com</b> so we can try to find a solution. These Terms apply to all
      ...
      <p>
        ...
        following the unsubscribe link or by emailing at contact@naschpitz.com.
      </p>
      ...
      <p>
        ...
        and (ii) that the posting of your Content on or through Service does not violate the privacy rights, publicity
      ...
      <p>
        ...
        through Service. You agree that this license includes the right for us to make your Content available to other
        users of Service, who may also use your Content subject to these Terms.
      </p>
      <p>Naschpitz.com has the right but not the obligation to monitor and edit all Content provided by users.</p>
      <p>
        In addition, Content found on or through this Service are the property of Naschpitz.com or used with permission.
      ...
      <p>
        0.2. For the purpose of exploiting, harming, or attempting to exploit or harm minors in any way by exposing them
      ...
      <p>
        0.1. Use Service in any manner that could disable, overburden, damage, or impair Service or interfere with any
      ...
      <p>
        0.6. Attempt to gain unauthorized access to, interfere with, damage, or disrupt any parts of Service, the server
      ...
      <p>
        ...
        remain the exclusive property of Naschpitz.com and its licensors. Service is protected by copyright, trademark,
        and other laws of and foreign countries. Our trademarks may not be used in connection with any product or
        service without the prior written consent of Naschpitz.com.
      </p>
      ...
      <p>
        ...
        contact@naschpitz.com, with the subject line: “Copyright Infringement” and include in your claim a detailed
      ...
      <p>
        You may provide us either directly at contact@naschpitz.com or via third party sites and tools with information
        and feedback concerning errors, suggestions for improvements, ideas, problems, complaints, and other matters
        related to our Service (“Feedback”). You acknowledge and agree that: (i) you shall not retain, acquire or assert
        any intellectual property right or other right, title or interest in or to the Feedback; (ii) Company may have
      ...
      <p>
        DEM.naschpitz.com has no control over, and assumes no responsibility for the content, privacy policies, or
      ...
      <p>
        These Terms shall be governed and construed in accordance with the laws of Netherlands, which governing law
      ...
      <p>
        Please send your feedback, comments, requests for technical support by email: <b>contact@naschpitz.com</b>.
      </p>
      <p style={{ marginTop: "5em", fontSize: "0.7em" }}>
        These <a href="https://policymaker.io/terms-conditions/">Terms and Conditions</a> were created for{" "}
        <b>dem.naschpitz.com</b> by <a href="https://policymaker.io">PolicyMaker.io</a> on 2020-05-28.
      </p>
    </div>
  )
}
