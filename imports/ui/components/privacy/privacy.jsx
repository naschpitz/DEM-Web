...
export default () => {
  return (
    <div id="privacy" className="container text-justify">
      ...
      <p>
        Welcome to <b> DEM.naschpitz.com</b>.
      </p>
      <p>
        <b>DEM.naschpitz.com</b> (“us”, “we”, or “our”) operates <b>DEM.naschpitz.com</b> (hereinafter referred to as{" "}
        <b>“Service”</b>).
      </p>
      <p>
        Our Privacy Policy governs your visit to <b>DEM.naschpitz.com</b>, and explains how we collect, safeguard and
      ...
      <p>
        <b>SERVICE</b> means the DEM.naschpitz.com website operated by DEM.naschpitz.com.
      </p>
      <p>
      ...
      <p>
        <b>DATA PROCESSORS (OR SERVICE PROVIDERS)</b> means any natural or legal person who processes the data on behalf
        of the Data Controller. We may use the services of various Service Providers in order to process your data more
        effectively.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        be used to contact or identify you (<b>“Personal Data”</b>). Personally identifiable information may include,
      ...
      <p>
        ...
        <a href="https://policymaker.io/non-disclosure-agreement/">non-disclosure agreements</a>, information on bonuses
      ...
      <p>DEM.naschpitz.com uses the collected data for various purposes:</p>
      ...
      <p>
        0.9. to carry out our obligations and enforce our rights arising from any contracts entered into between you and
      ...
      <p>
        If you are located outside Netherlands and choose to provide information to us, please note that we transfer the
        data, including Personal Data, to Netherlands and process it there.
      </p>
      <p>
      ...
      <p>
        DEM.naschpitz.com will take all the steps reasonably necessary to ensure that your data is treated securely and
      ...
      <p>
        ...
        systems, please email us at <b>contact@naschpitz.com</b>.
      </p>
      ...
      <p>
        0.4. users are able to change their personal information by emailing us at <b>contact@naschpitz.com</b>.
      </p>
      ...
      <p>
        ...
        data and not to sell (share) it. To exercise your data protection rights, you can make certain requests and ask
        us:
      </p>
      <p>
      ...
      <p>
        <b>
          0.2. To delete your personal information. If you make this request, we will delete the personal information we
          hold about you as of the date of your request from our records and direct any service providers to do the
          same. In some cases, deletion may be accomplished through de-identification of the information. If you choose
          to delete your personal information, you may not be able to use certain functions that require your personal
      ...
      <p>
        <b>
          ...
          without monetary consideration may be considered a “sale” under California law. You are the only owner of your
      ...
      <p>
        ...
        personal information to function. But in no circumstances, we will discriminate against you for exercising your
        rights.
      </p>
      <p>
        To exercise your California data protection rights described above, please send your request(s) by email:{" "}
        <b>contact@naschpitz.com</b>.
      </p>
      <p>
        Your data protection rights, described above, are covered by the CCPA, short for the California Consumer Privacy
        Act. To find out more, visit the official California Legislative Information website. The CCPA took effect on
        01/01/2020.
      </p>
      <p>
      ...
      <p>
        If you have any questions about this Privacy Policy, please contact us by email: <b>contact@naschpitz.com</b>.
      </p>
