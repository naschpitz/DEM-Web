                ...
                {!currentUser ?
                    <React.Fragment>
                        <li className="nav-item">
                            <Link className="nav-link" id="register" to="#" onClick={onRegisterClick}><FaPlus className="align-middle"/> Register</Link>
                        </li>

                        {Session.get('passwordResetToken') ?
                            <li className="nav-item">
                                <Link className="nav-link" id="resetPassword" to="#"><FaSyncAlt className="align-middle"/> Reset Password</Link>
                            </li> : null
                        }
                    </React.Fragment>: null
                }
        ...
        if (currentUser) {
            ...
            return (
                <li className="nav-item dropdown" id="userDropdown">
                    ...
                    <div className="dropdown-menu" aria-labelledby="userDropdown">
                        <Link className="dropdown-item" id="changePasswordLink" to="#" onClick={onChangePasswordClick}><FaKey className="align-middle"/> Change Password</Link>
                        {!verified ?
                            <Link className="dropdown-item" id="confirmEmailLink" to="#" onClick={onConfirmEmailClick}><FaSyncAlt className="align-middle"/> Re-send Confirmation</Link> : null
                        }
                        <Link className="dropdown-item" id="logoutLink" to="#" onClick={onLogoutClick}><FaSignOutAlt className="align-middle"/> Logout</Link>
                    </div>
                </li>
            );
        }
            ...
            return (
                <li className="nav-item" id="login">
                    <Link key="login" className="nav-link" id="loginLink" to="#" onClick={onLoginClick}><FaSignInAlt className="align-middle"/> Login</Link>
                </li>
            );
        }
    }
