...
export default Disclaimer = () => {
  return (
    <div id="disclaimer" className="container text-justify">
      ...
      <p>
        The information provided by <b>DEM.naschpitz.com</b> (“Company”, “we”, “our”, “us”) on <b>dem.naschpitz.com</b>{" "}
      ...
      <p>
        ...
        reliable sources, DEM.naschpitz.com is not responsible for any errors or omissions or for the results obtained
        from the use of this information. All information in this site is provided “as is”, with no guarantee of
      ...
      <p>
        In no event will DEM.naschpitz.com, its related partnerships or corporations, or the partners, agents or
        employees thereof be liable to you or anyone else for any decision made or action taken in reliance on the
        information in this Site or for any consequential, special or similar damages, even if advised of the
      ...
      <p>
        All logos and trademarks of third parties referenced on dem.naschpitz.com are the trademarks and logos of their
        respective owners. Any inclusion of such trademarks or logos does not imply or constitute any approval,
        endorsement or sponsorship of DEM.naschpitz.com by such owners.
      </p>
      <p>
        <b>CONTACT US</b>
      </p>
      <p>
        ...
        email: <b>contact@naschpitz.com</b>.
      </p>
      <p style={{ marginTop: "5em", fontSize: "0.7em" }}>
        This <a href="https://policymaker.io/disclaimer/">Disclaimer</a> was created for <b>dem.naschpitz.com</b> by{" "}
        <a href="https://policymaker.io">PolicyMaker.io</a> on 2020-05-28.
      </p>
    </div>
  )
}
