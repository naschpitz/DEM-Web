...
Cypress.Commands.add("createCreddotOneCompany", (name, group) => {
  ...
  cy.get(".card-header")
    .contains("Companies Under Management")
    .parent()
    .within(() => {
...
Cypress.Commands.add("createCreddotOneCompaniesGroup", title => {
  ...
  cy.get(".card-header")
    .contains("Groups Under Management")
    .parent()
    .within(() => {
...
Cypress.Commands.add("inviteUser", email => {
  ...
  cy.contains("Users Under Management")
    .parent()
    .within(() => {
      cy.contains(email)
    })
